-- Migration 012: Fix handle_new_user to include referral_id
-- Purpose: Add referral_id generation to fix "Database error saving new user"
-- The referral_id column is NOT NULL but wasn't being set in migration 011
