...
export async function createSubscriptionCheckout(
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    success_url: `${process.env.NEXT_PUBLIC_URL}/hub/ai-tutors/${aiTutorId}?subscription=success`,
    cancel_url: `${process.env.NEXT_PUBLIC_URL}/hub/ai-tutors/${aiTutorId}?subscription=canceled`,
  });
...
export async function createBillingPortalSession(
  ...
  const session = await stripe.billingPortal.sessions.create({
    ...
    return_url: `${process.env.NEXT_PUBLIC_URL}/hub/ai-tutors/${aiTutorId}`,
  });
