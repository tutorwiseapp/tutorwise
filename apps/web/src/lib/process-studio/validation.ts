 ...
 * Extracted from /api/process-studio/parse/route.ts for reuse by the Discovery Engine scanners.
 */

import type { ProcessStepType } from '@/components/feature/process-studio/types';
