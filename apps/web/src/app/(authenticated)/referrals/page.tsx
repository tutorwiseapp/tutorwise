...
import ReferralCard from '@/components/feature/referrals/content/ReferralCard';
import ReferAndEarnView from '@/components/feature/referrals/tabs/ReferAndEarnView';
import ReferralPerformanceTab from '@/components/feature/referrals/tabs/ReferralPerformanceTab';
import ReferralStatsWidget from '@/components/feature/referrals/sidebar/ReferralStatsWidget';
import ReferralActivityFeed from '@/components/feature/referrals/sidebar/ReferralActivityFeed';
import ReferralHelpWidget from '@/components/feature/referrals/sidebar/ReferralHelpWidget';
import ReferralTipWidget from '@/components/feature/referrals/sidebar/ReferralTipWidget';
import ReferralVideoWidget from '@/components/feature/referrals/sidebar/ReferralVideoWidget';
import HubSidebar from '@/components/hub/sidebar/HubSidebar';
import ReferralsSkeleton from '@/components/feature/referrals/ui/ReferralsSkeleton';
import ReferralsError from '@/components/feature/referrals/ui/ReferralsError';
...
export default function ReferralsPage() {
  ...
  if (profileLoading || isLoading) {
    return (
      <HubPageLayout
        header={<HubHeader title={activeTab === 'refer-and-earn' ? 'Refer & Earn 10% Commission' : 'Referrals'} />}
  ...
  return (
    <HubPageLayout
      header={
        <HubHeader
          title={activeTab === 'refer-and-earn' ? 'Refer & Earn 10% Commission' : 'Referrals'}
          filters={
            activeTab === 'leads' ? (
