...
import ProfessionalInfoForm from '@/components/feature/account/ProfessionalInfoForm';
...
import { showScoreCelebration } from '@/components/ui/feedback/ScoreCelebrationToast';
