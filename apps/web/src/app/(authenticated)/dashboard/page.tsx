...
import { PendingLogsWidget } from '@/components/feature/dashboard/content/PendingLogsWidget';
import { VirtualSpaceWidget } from '@/components/feature/dashboard/content/VirtualSpaceWidget';
import KPIGrid from '@/components/feature/dashboard/performance/KPIGrid';
import { HubEarningsTrendChart, HubCalendarHeatmap, type WeeklyEarnings, type DayData } from '@/components/hub/charts';
import ProfileGrowthWidget from '@/components/feature/dashboard/performance/ProfileGrowthWidget';
import FirstLoginModal from '@/components/feature/dashboard/content/FirstLoginModal';
import TipsCard from '@/components/feature/dashboard/performance/TipsCard';
import DashboardHelpWidget from '@/components/feature/dashboard/sidebar/DashboardHelpWidget';
import DashboardVideoWidget from '@/components/feature/dashboard/sidebar/DashboardVideoWidget';
import { TooltipProvider } from '@/components/ui/Tooltip';
import MessagesWidget from '@/components/feature/dashboard/performance/MessagesWidget';
import PayoutWidget from '@/components/feature/dashboard/performance/PayoutWidget';
import { HubStudentTypeBreakdown, type StudentTypeData } from '@/components/hub/charts';
