/**
 * Filename: workshop/page.tsx
 * Purpose: Workshop event listing creation page
...
import TutorWorkshopForm from '@/components/feature/listings/create/tutor/WorkshopForm';
import AgentWorkshopForm from '@/components/feature/listings/create/agent/WorkshopForm';
    ...
    <HubPageLayout
      header={
        <ListingsHeader
          ...
          subtitle="Set up your educational workshop or seminar"
        />
      }
      tabs={<HubTabs tabs={tabs} onTabChange={handleTabChange} />}
      sidebar={
