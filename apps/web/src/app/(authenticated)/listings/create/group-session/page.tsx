...
import GroupSessionForm from '@/app/components/feature/listings/create/provider/GroupSessionForm';
...
export default function CreateGroupSessionPage() {
  ...
  const [activeTab] = useState<'one-to-one' | 'group-session' | 'workshop' | 'study-package'>('group-session');
  ...
  return (
    <div className={styles.createPage}>
      ...
      <GroupSessionForm onSubmit={handleSubmit} onCancel={() => router.push('/listings')} isSaving={isSaving} initialData={initialData} />
    </div>
  );
}
