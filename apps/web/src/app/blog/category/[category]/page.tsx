/**
 * Filename: apps/web/src/app/blog/category/[category]/page.tsx
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: `${categoryInfo.label} Articles | Tutorwise Blog`,
      description: categoryInfo.description,
      url: `https://tutorwise.com/blog/category/${params.category}`,
      siteName: 'Tutorwise',
      type: 'website',
    },
    alternates: {
      canonical: `https://tutorwise.com/blog/category/${params.category}`,
    },
  };
}
