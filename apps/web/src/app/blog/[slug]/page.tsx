...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://tutorwise.com/blog/${article.slug}`,
    },
  };
}
...
export default async function BlogArticlePage({ params }: { params: { slug: string } }) {
  ...
  fetch(`${process.env.NEXT_PUBLIC_SITE_URL || ''}/api/blog/articles/${article.slug}`, {
    method: 'GET',
    cache: 'no-store',
  }).catch(() => {});
    ...
    <>
      ...
      <article className={styles.article}>
        ...
        <nav className={styles.breadcrumb}>
          ...
          <Link href={`/blog/category/${article.category}`} className={styles.breadcrumbLink}>
            {categoryLabel}
        </Link>
        <span className={styles.breadcrumbSeparator}>/</span>
