/**
 * Filename: api/ai-tutors/[id]/materials/route.ts
 * Purpose: AI Tutor Materials API - Upload and list materials
 * Created: 2026-02-23
 * Version: v1.0
 *
 * Routes:
 * - POST /api/ai-tutors/[id]/materials - Upload material
 * - GET /api/ai-tutors/[id]/materials - List materials
 */
...
import {
  ...
  listMaterials,
  checkStorageQuota,
} from '@/lib/ai-tutors/material-upload';

/**
 * POST /api/ai-tutors/[id]/materials
...
/**
 * GET /api/ai-tutors/[id]/materials
