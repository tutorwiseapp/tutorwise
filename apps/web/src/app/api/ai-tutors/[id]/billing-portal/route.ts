/**
 * Filename: api/ai-tutors/[id]/billing-portal/route.ts
...
import { createBillingPortalSession } from '@/lib/ai-tutors/subscription-manager';

/**
 * POST /api/ai-tutors/[id]/billing-portal
