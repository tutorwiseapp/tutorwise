/**
 * Filename: api/ai-tutors/[id]/links/[linkId]/route.ts
 * Purpose: Individual Link API - Update and delete links
 * Created: 2026-02-23
 * Version: v1.0
 *
 * Routes:
 * - PATCH /api/ai-tutors/[id]/links/[linkId] - Update link
 * - DELETE /api/ai-tutors/[id]/links/[linkId] - Delete link
 */

import { NextRequest, NextResponse } from 'next/server';
import { createClient } from '@/utils/supabase/server';
import { updateLink, deleteLink } from '@/lib/ai-tutors/links-manager';

/**
 * PATCH /api/ai-tutors/[id]/links/[linkId]
...
/**
 * DELETE /api/ai-tutors/[id]/links/[linkId]
