/**
 * Filename: api/ai-tutors/[id]/skills/route.ts
 * Purpose: AI Tutor Skills Management API
 * Created: 2026-02-24
 * Version: v1.0 (Phase 2)
 *
 * Routes:
 * - GET /api/ai-tutors/[id]/skills - Get AI tutor skills
 * - POST /api/ai-tutors/[id]/skills - Add skill to AI tutor
 * - DELETE /api/ai-tutors/[id]/skills - Remove skill from AI tutor
 */
...
/**
 * DELETE /api/ai-tutors/[id]/skills
