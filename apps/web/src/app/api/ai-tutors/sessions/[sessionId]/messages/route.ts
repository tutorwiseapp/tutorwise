/**
 * Filename: api/ai-tutors/sessions/[sessionId]/messages/route.ts
...
import { retrieveContext } from '@/lib/ai-tutors/rag-retrieval';
import { GeminiProvider } from '@/lib/ai-tutors/gemini-provider';

/**
 * POST /api/ai-tutors/sessions/[sessionId]/messages
...
export async function POST(
  ...
  try {
    ...
    const ragResult = await retrieveContext(message.trim(), session.ai_tutor_id, 5);
