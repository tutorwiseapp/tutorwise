...
import { analyzeToWorkflow } from '@/lib/workflow/scanner/ai-analyzer';
import { detectOverlap } from '@/lib/workflow/scanner/overlap-detector';
import type { ConfidenceLevel, SourceType } from '@/lib/workflow/scanner/types';
...
/**
 * POST /api/workflow/discovery/analyse-batch
 *
