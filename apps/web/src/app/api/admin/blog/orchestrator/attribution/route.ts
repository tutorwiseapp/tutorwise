/**
 * Filename: apps/web/src/app/api/admin/blog/orchestrator/attribution/route.ts
...
/**
 * GET /api/admin/blog/orchestrator/attribution?days=30
 *
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (comparisonError) {
      console.error('[Blog Orchestrator] Attribution Comparison RPC Error:', comparisonError);
    ...
    console.error('[Blog Orchestrator] Attribution Error:', error);
