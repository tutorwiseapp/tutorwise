/**
 * Filename: apps/web/src/app/api/admin/signal/journey/route.ts
...
/**
 * GET /api/admin/signal/journey?signal_id=dist_abc123
 *
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (journeyError) {
      console.error('[Revenue Signal] Journey RPC Error:', journeyError);
    ...
    console.error('[Revenue Signal] Journey Error:', error);
