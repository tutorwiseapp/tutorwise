/**
 * Filename: route.ts
 * Purpose: Remove payment method from organisation subscription
 * Created: 2026-01-08
 *
 * POST /api/stripe/organisation/remove-card
 * Detaches a payment method from the organisation's Stripe customer
 */
