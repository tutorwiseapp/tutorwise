/**
 * Filename: apps/web/src/app/api/blog/listing-links/click/route.ts
...
/**
 * POST /api/blog/listing-links/click
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[API] Error in POST /api/blog/listing-links/click:', error);
