/**
 * Filename: apps/web/src/app/api/blog/saves/check/route.ts
...
/**
 * GET /api/blog/saves/check?articleId=xxx
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('[API] Error in GET /api/blog/saves/check:', error);
    return NextResponse.json({ isSaved: false });
  }
}
