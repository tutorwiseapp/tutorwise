/**
 * Filename: api/ai-agents/custom-skills/route.ts
 * Purpose: Custom Skills Management API
 * Created: 2026-02-24
 * Version: v1.0 (Phase 2)
 *
 * Routes:
 * - POST /api/ai-agents/custom-skills - Create custom skill
 * - GET /api/ai-agents/custom-skills - List custom skills
 */
...
/**
 * POST /api/ai-agents/custom-skills
...
/**
 * GET /api/ai-agents/custom-skills
