/**
 * Filename: api/ai-agents/[id]/subscription/route.ts
 * Purpose: AI Tutor Subscription API - Manage £10/month subscriptions
 * Created: 2026-02-23
 * Version: v1.0
 *
 * Routes:
 * - POST /api/ai-agents/[id]/subscription - Create subscription checkout
 * - GET /api/ai-agents/[id]/subscription - Get subscription details
 * - DELETE /api/ai-agents/[id]/subscription - Cancel subscription
 * - PATCH /api/ai-agents/[id]/subscription - Reactivate subscription
 */
...
/**
 * POST /api/ai-agents/[id]/subscription
...
/**
 * GET /api/ai-agents/[id]/subscription
...
/**
 * DELETE /api/ai-agents/[id]/subscription
...
/**
 * PATCH /api/ai-agents/[id]/subscription
