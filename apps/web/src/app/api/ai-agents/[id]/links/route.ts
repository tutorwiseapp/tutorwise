/**
 * Filename: api/ai-agents/[id]/links/route.ts
 * Purpose: AI Tutor Links API - Add and list URL references
 * Created: 2026-02-23
 * Version: v1.0
 *
 * Routes:
 * - POST /api/ai-agents/[id]/links - Add URL link
 * - GET /api/ai-agents/[id]/links - List links
 */

import { NextRequest, NextResponse } from 'next/server';
import { createClient } from '@/utils/supabase/server';
import { addLink, listLinks } from '@/lib/ai-agents/links-manager';

/**
 * POST /api/ai-agents/[id]/links
