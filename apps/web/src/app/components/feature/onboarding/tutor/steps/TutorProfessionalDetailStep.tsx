...
const TutorProfessionalDetailStep: React.FC<TutorProfessionalDetailStepProps> = ({
  ...
  const { configs, isLoading: isLoadingConfigs } = useFormConfigs([
    { fieldName: 'bio', context: 'onboarding.tutor', fallback: { label: 'About You', placeholder: 'Describe your tutoring or teaching style, strengths, and what areas you specialise in', helpText: 'characters minimum' } },
    { fieldName: 'bioVideoUrl', context: 'onboarding.tutor', fallback: { label: '30-Second Intro Video (Optional)', placeholder: 'Paste YouTube, Loom, or Vimeo URL for +5 CaaS points' } },
    { fieldName: 'status', context: 'onboarding.tutor', fallback: { label: 'Status', placeholder: 'Select status', options: statusOptions } },
    { fieldName: 'academicQualifications', context: 'onboarding.tutor', fallback: { label: 'Academic Qualifications', placeholder: 'Select qualifications', options: academicQualificationsOptions } },
    { fieldName: 'teachingProfessionalQualifications', context: 'onboarding.tutor', fallback: { label: 'Teaching Professional Qualifications', placeholder: 'Select qualifications', options: teachingProfessionalQualificationsOptions } },
    { fieldName: 'teachingExperience', context: 'onboarding.tutor', fallback: { label: 'Teaching Experience', placeholder: 'Select experience', options: teachingExperienceOptions } },
    { fieldName: 'tutoringExperience', context: 'onboarding.tutor', fallback: { label: 'Tutoring Experience', placeholder: 'Select experience', options: tutoringExperienceOptions } },
    { fieldName: 'keyStages', context: 'onboarding.tutor', fallback: { label: 'Key Stages', placeholder: 'Select key stages', options: keyStagesOptions } },
