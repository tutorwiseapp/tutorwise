...
export default function PerformanceInsights({
  ...
  weeklyLeaderboard = {
    topPerformer: { firstName: 'Sarah', count: 12 },
    totalActive: 45,
  },
        ...
        <div className={styles.section}>
          ...
          <div className={styles.activityList}>
            ...
            <div className={styles.activityItem}>
              ...
              <span className={styles.activityValue}>
                {weeklyLeaderboard.topPerformer.firstName}, {weeklyLeaderboard.topPerformer.count} referrals
              </span>
            </div>
            <div className={styles.activityItem}>
              <Award className={styles.rankIcon} size={16} />
