/**
 * Filename: apps/web/src/app/components/reviews/ReviewsError.tsx
...
export default function ReviewsError({ error, onRetry }: ReviewsErrorProps) {
  return (
    <div className={styles.container}>
      <div className={styles.errorCard}>
        ...
        <h3 className={styles.title}>Failed to Load Reviews</h3>
