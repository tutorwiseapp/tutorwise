/**
 * Filename: apps/web/src/app/components/referrals/ReferralsError.tsx
 * Purpose: Error state for referrals page
 * Created: 2025-11-09
 */
...
interface ReferralsErrorProps {
  error: Error;
  onRetry: () => void;
}

export default function ReferralsError({ error, onRetry }: ReferralsErrorProps) {
  return (
    <div className={styles.container}>
      <div className={styles.errorCard}>
        ...
        <h3 className={styles.title}>Failed to Load Referrals</h3>
        <p className={styles.message}>
          {error?.message || 'An unexpected error occurred while loading referrals.'}
        </p>
