 ...
 * Purpose: Modal component for sharing profiles/listings with multiple platform options
 * Created: 2025-12-08
 */
        ...
        <div className={styles.content}>
          ...
          <div className={styles.shareGrid}>
            {shareOptions.map((option) => (
              ...
              >
                <div className={styles.shareIcon}>{option.icon}</div>
          ...
          {typeof window !== 'undefined' && 'share' in navigator && (
            <>
              ...
              <button onClick={handleNativeShare} className={styles.nativeShareButton}>
