 ...
 * Created: 2025-12-17
 * Pattern: Simple, self-contained chart (Dashboard design)
 */
...
const HubEarningsTrendChart = memo(function HubEarningsTrendChart({
  ...
  // Generate placeholder data if empty to show axes and structure
  const chartData = useMemo(() => {
    if (data && data.length > 0) {
      return data;
    }
    // Generate 6 weeks of placeholder data with £0 values
