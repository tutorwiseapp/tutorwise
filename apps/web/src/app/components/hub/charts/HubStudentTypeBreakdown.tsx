/**
 * Filename: HubStudentTypeBreakdown.tsx
 * Purpose: Chart showing breakdown of new vs returning students
 * Created: 2025-12-17
 * Pattern: Reusable widget for Dashboard, Organisation, and other hubs
 */
...
import styles from './HubStudentTypeBreakdown.module.css';
...
interface HubStudentTypeBreakdownProps {
...
export default HubStudentTypeBreakdown;
