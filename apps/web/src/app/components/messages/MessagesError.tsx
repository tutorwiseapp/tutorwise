/**
 * Filename: apps/web/src/app/components/messages/MessagesError.tsx
 * Purpose: Error state for messages page
 * Created: 2025-11-09
 */
...
export default function MessagesError({ error, onRetry }: MessagesErrorProps) {
  return (
    <div className={styles.container}>
      <div className={styles.errorCard}>
        ...
        <h3 className={styles.title}>Failed to Load Messages</h3>
        <p className={styles.message}>
          {error?.message || 'An unexpected error occurred while loading your messages.'}
        </p>
