...
import AdminAITutorDetailModal from './AdminAITutorDetailModal';
...
import styles from './AITutorsTable.module.css';
...
export default function AITutorsTable() {
  ...
  const handleExport = () => {
    ...
    exportToCSV(data.aiTutors, columns, 'ai-tutors');
  };
  ...
  return (
    <>
      ...
      <HubDataTable
        ...
        savedViewsKey="admin-ai-tutors-views"
