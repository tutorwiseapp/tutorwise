/**
 * Filename: AdminAITutorCreateTab.tsx
...
import styles from './AdminAITutorCreateTab.module.css';

interface AdminAITutorCreateTabProps {
  onSuccess?: () => void;
}

export default function AdminAITutorCreateTab({ onSuccess }: AdminAITutorCreateTabProps) {
