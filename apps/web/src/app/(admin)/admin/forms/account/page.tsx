/*
 * Filename: src/app/(admin)/admin/forms/account/page.tsx
 * Purpose: Account forms configuration page with role tabs
 * Created: 2026-01-12
 */
'use client';
...
export default function AccountFormsPage() {
  ...
  const context = `account.${roleFilter}`;
  ...
  const handleRoleChange = (roleId: string) => {
    ...
    router.push(`/admin/forms/account?${params.toString()}`);
  };
  ...
  return (
    <HubPageLayout
      header={
        <HubHeader
          title="Account Forms"
          subtitle="Manage form configurations for account management"
          actions={
