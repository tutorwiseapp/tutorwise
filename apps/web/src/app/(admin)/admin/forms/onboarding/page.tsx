/*
 * Filename: src/app/(admin)/admin/forms/onboarding/page.tsx
 * Purpose: Onboarding forms configuration page with role tabs
 * Created: 2026-01-12
 */
'use client';
...
export default function OnboardingFormsPage() {
  ...
  const context = `onboarding.${roleFilter}`;
  ...
  const handleRoleChange = (roleId: string) => {
    ...
    router.push(`/admin/forms/onboarding?${params.toString()}`);
  };
    ...
    <HubPageLayout
      header={
        <HubHeader
          ...
          subtitle="Manage form configurations for onboarding flows"
        />
      }
