 ...
 * Purpose: Admin Users management page (grant/revoke admin access, change roles)
 * Created: 2025-12-23
...
export default function AdminUsersPage() {
  ...
  const handleTabChange = (tabId: string) => {
    ...
    router.push(`/admin/users/admins${params.toString() ? `?${params.toString()}` : ''}`);
  };
      ...
      tabs={
        <HubTabs
          tabs={[
            ...
            { id: 'superadmin', label: 'Superadmins', count: stats.superadmin, active: roleFilter === 'superadmin' },
