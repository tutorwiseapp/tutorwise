-- Migration 018: Final working trigger with name extraction
-- Purpose: Now that we know the trigger fires, add name extraction back
...
COMMENT ON FUNCTION handle_new_user() IS 'Creates profile on signup. Extracts and parses name data from metadata. Has robust error handling.';
