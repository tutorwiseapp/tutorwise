-- Migration 020: Standardize on first_name/last_name throughout the app
-- Purpose: Use first_name/last_name as primary fields, support given_name/family_name for OAuth compatibility
...
COMMENT ON FUNCTION handle_new_user() IS 'Creates profile on signup. Uses first_name/last_name as standard, supports given_name/family_name for OAuth. Has robust error handling.';
