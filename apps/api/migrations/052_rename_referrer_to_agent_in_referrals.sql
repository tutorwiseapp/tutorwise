-- Migration 052: Rename referrer_profile_id to agent_profile_id in referrals table
...
-- ============================================================
-- 1. RENAME REFERRER_PROFILE_ID TO AGENT_PROFILE_ID IN REFERRALS
-- ============================================================
...
ALTER TABLE public.referrals
ADD CONSTRAINT referrals_agent_profile_id_fkey
...
CREATE INDEX idx_referrals_agent_id
  ON public.referrals(agent_profile_id);
...
VALUES (
  ...
  jsonb_build_object(
    'migration', '052',
    'changes', ARRAY[
      'Renamed referrer_profile_id to agent_profile_id in referrals table',
