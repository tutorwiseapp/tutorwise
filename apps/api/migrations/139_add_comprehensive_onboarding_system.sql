-- =====================================================================
-- Migration: Add Comprehensive User Onboarding System
-- Version: 139
-- Created: 2025-09-29 (Migrated to apps/api/migrations: 2025-12-23)
-- Description: Adds comprehensive tables and fields for user role onboarding system
-- Note: This supersedes the simpler migration 001_create_onboarding_progress_table.sql
--       Both can coexist safely as this migration uses IF NOT EXISTS clauses
-- =====================================================================
