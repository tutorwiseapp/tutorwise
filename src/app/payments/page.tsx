 ...
 * Purpose: Allows users to manage payment methods, with styles mirrored from the Dashboard.
...
import styles from './page.module.css'; // --- THIS IS THE FIX ---
...
const PaymentsPageContent = () => {
    ...
    if (isProfileLoading || isLoadingData) {
        return <Container><PageHeader title="Payments" /><p className={styles.loading}>Loading...</p></Container>;
    }
    ...
    return (
        <Container>
            ...
            <div className={styles.grid}>
                ...
                <div className={styles.gridCard}>
                    ...
                    <div className={styles.cardActions}>
                        ...
                        {stripeAccount?.details_submitted && (
                            <Button onClick={handleDisconnect} variant="link" className={`${styles.cardLink} ${styles.disconnect}`}>
                                Disconnect
                            </Button>
                        )}
                    </div>
                ...
                <div className={`${styles.gridCard} ${styles.spanFull}`}>
                    <div className={styles.cardContent}>
