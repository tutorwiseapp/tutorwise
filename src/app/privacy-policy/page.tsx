  ...
  return (
    <Container className={styles.container}>
      ...
      <div className={styles.legalText}>
        ...
        <h2>2. How We Use Your Information</h2><p>We use the information we collect to operate, maintain, and provide the features and functionality of the Vinite platform.</p>
      </div>
    </Container>
  );
};
